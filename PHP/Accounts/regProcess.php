...
if (
    ...
    $query = "INSERT INTO users (username, firstname, lastname, email, password, createDate) VALUES ('$username', '$firstname', '$lastname', '$email', '" . password_hash($pass, PASSWORD_DEFAULT) . "', '$createDate')";
